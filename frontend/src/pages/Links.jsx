      ...
      <div className="w-[55%] p-8 rounded-lg flex flex-col hide-scrollbar overflow-y-auto">
        ...
        <div className="rounded-lg h-36 w-full bg-white mt-10 p-4 flex flex-col">
          <div className="w-full">
            <button className="rounded-full py-2 px-4 text-white text-sm bg-[#28A263]">
              Add Link
            </button>
            <button className="rounded-full py-2 px-4 bg-gray-100 text-gray-600 text-sm ml-2">
              Add Shop
            </button>
          </div>
          <div className="w-full">
            <button className="rounded-full w-full py-2 text-white text-md bg-[#28A263] mt-6">
              + Add
            </button>
          </div>
        </div>
